...
const SavingsPrecipitationAggregatedChartContent = ( { chartType, layoutHandler }: Props1Type ) => {
...
const SavingsPrecipitationChartContent = ( { dataParser, chartType, layoutHandler }: PropsType ) => {

    switch ( dataParser.type ) {

        case 'standard':
            return ( <SavingsPrecipitationAggregatedChartContent
                chartType={ chartType }
...
export { SavingsPrecipitationChartContent, SavingsPrecipitationAggregatedChartContent };